...
SET(MYLIBS "dbug;strings;regex;mysys;mysys_ssl;vio;zlib;archive_embedded;blackhole_embedded;csv_embedded;federated_embedded;heap_embedded;innobase_embedded;lz4_lib;myisam_embedded;myisammrg_embedded;partition_embedded;ngram_parser_embedded;sql_embedded")
SET(MYSQL_CMAKE_SCRIPT_DIR "/home/xzf/percona/percona-server-5.7.44-48/cmake")

SET(CMAKE_AR "/usr/bin/ar")
SET(CMAKE_BINARY_DIR "/home/xzf/percona/percona-server-5.7.44-48")
...
ELSEIF(LINUX)
  ...
  FOREACH(LIB ${LIB_LOCATIONS})
    SET(CONTENT "${CONTENT}addlib ${LIB}\n")
  ENDFOREACH()
